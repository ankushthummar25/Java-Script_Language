...
// JSON stands for Javascript Object Notation. JSON is a text-based
// data format that is used to store and transfer data.
...
// JavaScript object literal syntax. However, the JSON format can be 
// accessed and be created by other programming languages too.



// JSON Data

// JSON data consists of key/value pairs similar to JavaScript object 
// properties. The key and values are written in double quotes separated 
...
// The JSON object is written inside curly braces { }. JSON objects can
//  contain multiple key/value pairs. For example,
...
// Note: JSON data can contain objects and arrays. However, unlike JavaScript 
...
// from JavaScript objects. Converting JSON to JavaScript Object
...
// built-in JSON.stringify() function.
